...
# carrega funcoes_eventos.py dinamicamente (evita problema com nomes de pasta)
_mod_path = os.path.join(os.path.dirname(__file__), "funcoes_eventos.py")
_spec = importlib.util.spec_from_file_location("funcoes_eventos", _mod_path)
funcoes = importlib.util.module_from_spec(_spec)
_spec.loader.exec_module(funcoes)

def display_menu():
    print("\n=== Planejador de Eventos (simples) ===")
